...
const KokanRangeTable: React.FC = () => {
  ...
  const data = [
    ...
    { sr: 4, commissionerate: { marathi: "मीरा भायंदर शहर", english: "Mira Bhayandar City" }, designation: { marathi: "पोलीस निरीक्षक", english: "Police Inspector" }, officerName: { marathi: "प्रभाकर झेंडे", english: "Prabhakar Zende" }, contact: "9823112469" },
