...
const ChtrapatiSambhajiNagarRange: React.FC = () => {
  ...
  const data = [
    { sr: 22, commissionerate: { marathi: "पोलीस मध्यवर्ती मोटर परिवहन कर्मशाळा, छत्रपती संभाजीनगर", english: "Chhatrapati Sambhaji Nagar w/shop" }, officerName: { marathi: "", english: "" }, designation: { marathi: "पोलीस  उप-अधीक्षक", english: "" }, contact: "" },
    ...
    { sr: 5, commissionerate: { marathi: "मोटार परिवहन विभाग,धाराशिव ", english: "Usmanabad" }, officerName: { marathi: "", english: "" }, designation: { marathi: "पोलीस निरीक्षक", english: "Police Inspector" }, contact: "" },
    ...
    { sr: 17, commissionerate: { marathi: "एसआरपीएफ ग्रुप 14. छत्रपती संभाजीनगर", english: "SRPF Group 14. Aurangabad" }, officerName: { marathi: "", english: "" }, designation: { marathi: "", english: "" }, contact: "" },
