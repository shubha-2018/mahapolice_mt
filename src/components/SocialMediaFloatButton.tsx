  ...
  const socialMediaIcons = [
    {
      ...
      url: "https://www.facebook.com/profile.php?id=61577135066429",
    ...
    },
    {
      ...
      url: "https://www.instagram.com/mh_police_pcit/",
    ...
    },
    {
      ...
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          <path d="M6.62 10.79a15.053 15.053 0 006.59 6.59l2.2-2.2a1 1 0 011.11-.21c1.21.48 2.53.74 3.88.74a1 1 0 011 1v3.5a1 1 0 01-1 1C10.07 22.9 1.1 13.93 1.1 3a1 1 0 011-1h3.5a1 1 0 011 1c0 1.35.25 2.67.74 3.88a1 1 0 01-.21 1.11l-2.2 2.2z" />
        </svg>
      ),
      url: "tel:+917066100112",
    ...
    },
    {
      ...
      url: "https://goo.gl/maps/abc123", // Replace with MT Office Aundh Google Maps link
