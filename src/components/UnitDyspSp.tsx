...
const UnitDyspSp: React.FC = () => {
  ...
  const data = [
    { sr: 1, unit: { marathi: " प्रशासन ", english: "" }, designation: { marathi: "पोलीस उप-अधीक्षक प्रशासन", english: "" }, name: { marathi: "श्री.उदयसिंह शिंगाडे ", english: "" }, contact: "9552565063" },  
   { sr: 2, unit: { marathi: "चालक प्रशिक्षण केंद्र ", english: "" }, designation: { marathi: "पोलीस  उप-अधीक्षक", english: "" }, name: { marathi: "श्री.अनंत माळी", english: "" }, contact: "8378979474" },
    { sr: 3, unit: { marathi: " भांडार खरेदी शाखा ", english: "" }, designation: { marathi: "पोलीस उप-अधीक्षक", english: "" }, name: { marathi: "श्री.रवींद्र  हिंगणेकर  (अतिरिक्त कार्याभार ) ", english: " " }, contact: "8108000062" },
    { sr: 4, unit: { marathi: " साठा  बांधणी विभाग ", english: "" }, designation: { marathi: "पोलीस निरीक्षक", english: "Police Inspector" }, name: { marathi: "ये.यन .सय्यद  ", english: " " }, contact: "9823186786" },
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-blue-600 dark:bg-blue-700 text-white">
                  ...
                  <th className="px-6 py-4 text-center font-semibold border border-blue-500 dark:border-blue-600">
                    {language === "marathi" ? "प्रभारी अधिकाऱ्याचे नाव" : "Name"}
                  </th>
                  <th className="px-4 py-4 text-center font-semibold border border-blue-500 dark:border-blue-600">
                    {language === "marathi"
                      ? "संपर्क क्रमांक"
              ...
              <tbody>
                {data.map((row, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-gray-800 dark:text-gray-200 border border-gray-300 dark:border-gray-600">
                      {language === "marathi" ? row.unit.marathi : row.unit.english}
                    </td>
                    ...
                    <td className="px-6 py-4 text-gray-800 dark:text-gray-200 border border-gray-300 dark:border-gray-600">
                      {row.name.marathi === "रिक्त" || row.name.english === "Vacant" ? (
                        ...
                        language === "marathi" ? row.name.marathi : row.name.english
                      )}
                    </td>
