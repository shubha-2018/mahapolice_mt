...
const AboutSection = () => {
  ...
  const aboutContent = {
    marathi: {
      title: 'मोटार  ट्रान्सपोर्ट बद्दल',
      description: 'महाराष्ट्र पोलीस मोटार  ट्रान्सपोर्ट विभाग हा १९४७ पासून राज्यातील पोलीस बलाच्या वाहतूक गरजा पूर्ण करत आहे. आमच्याकडे आधुनिक वाहन संच, कुशल ड्रायव्हर्स आणि तांत्रिक कर्मचारी आहेत. आम्ही पर्यावरण संरक्षण, तंत्रज्ञान वापर आणि सुरक्षितता यांना प्राधान्य देतो.',
      readMore: 'अधिक वाचा'
    },
    english: {
