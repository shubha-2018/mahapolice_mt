...
const leaders: Leader[] = [
  {
    ...
    designation: {
      marathi: 'मुख्यमंत्री, महाराष्ट्र',
      english: 'Chief Minister, Maharashtra'
    },
  ...
  },
  {
    ...
    designation: {
      marathi: 'गृहमंत्री, महाराष्ट्र',
      english: 'Home Minister, Maharashtra'
    },
  ...
  },
  {
    ...
    designation: {
      marathi: 'राज्य गृहमंत्री, महाराष्ट्र',
      english: 'Minister of State for Home, Maharashtra'
    },
  ...
  },
  {
    id: 4,
    name: {
      marathi: 'श्री. इकबाल सिंग चहल',
      english: 'Shri. Iqbal Singh Chahal'
    },
    designation: {
      marathi: 'मुख्य सचिव, महाराष्ट्र',
      english: 'Chief Secretary, Maharashtra'
    },
  ...
  },
  {
    id: 5,
    name: {
      marathi: 'श्रीमती. रश्मी शुक्ला',
      english: 'Smt. Rashmi Shukla'
    },
    designation: {
      marathi: 'पोलीस महासंचालक, महाराष्ट्र',
      english: 'Director General of Police, Maharashtra'
    },
  ...
  },
  {
    id: 6,
    name: {
      marathi: 'श्री. दीपक शिवानंद पांडे',
      english: 'Shri. Deepak Shivanand Pandey'
    },
    designation: {
      marathi: 'अप महासंचालक (मोटर ट्रान्सपोर्ट)',
      english: 'Additional Director General (Motor Transport)'
    },
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {leaders.map((leader, index) => (
            <Card
              key={leader.id}
              className={`police-card hover-lift group transition-all duration-500 fade-in-up animate`}
              style={{ animationDelay: `${index * 150}ms` }}
            >
              <CardContent className="p-6 text-center">
                {/* Portrait */}
                <div className="relative mb-6 mx-auto w-32 h-32 rounded-full overflow-hidden border-2 border-dashed border-primary/60 bg-primary/10 flex items-center justify-center group-hover:shadow-glow transition-all duration-300">
                  <img
                    src={leader.imageUrl}
                    alt={leader.name.english}
                ...
                <div className="space-y-2">
                  <h3
                    className={`police-heading text-xl group-hover:text-accent transition-colors ${
                      language === 'marathi' ? 'marathi-text' : 'english-text'
                    }`}
                  >
                  ...
                  <div className="w-16 h-1 bg-primary mx-auto rounded-full group-hover:bg-accent group-hover:w-20 transition-all duration-300"></div>
                </div>
              </CardContent>
            </Card>
          ))}
